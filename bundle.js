...
/******/ 	__webpack_require__.p = "http://localhost:8090/build";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LsdSlider = __webpack_require__(148)
	...
	ReactDOM.render(
	  React.createElement(LsdSlider, {key: "1", width: "300", multiple: "4", min: "1", max: "8", cumulativeOffset: cumulativeOffset}),
	  document.getElementById('lsd-slider-1')
	);

	ReactDOM.render(
	  React.createElement(LsdSlider, {key: "2", height: "240", multiple: "3", cumulativeOffset: cumulativeOffset}),
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var LsdSliderHandle = React.createClass({displayName: "LsdSliderHandle",
	  /*
	    ...
	    */
	    ...
	    return (
	      React.createElement("div", {
	        ...
	        style: style, 
	        ref: function(ref)  {return this.componentInstance = ref;}.bind(this)}, 
	        React.createElement("div", {className: "sun"}, 
	            React.createElement("div", {className: "ray", id: "ray1"}), 
	            React.createElement("div", {className: "ray", id: "ray2"}), 
	            React.createElement("div", {className: "ray", id: "ray3"}), 
	            React.createElement("div", {id: "suncore"})
	        )
	      )
	    );
	  }
	...
	*    }
	*/
	var LsdSliderRange = React.createClass({displayName: "LsdSliderRange",
	  render: function() {
	    var style = (this.props.orientation == "x")?
	      {
	  ...
	  */
	  ...
	  computeHandlePosition: function(handleId, mouseCoords, handleDimension) {
	    ...
	    */
	    ...
	    return {realValue:realValue, offsetValue:offsetValue};
	  },
	  ...
	  render: function() {
	    ...
	    */
	    ...
	    for(var i=0; i<this.state.handleCount; i++){
	      handles.push(
	        React.createElement(LsdSliderHandle, {
	          key: i, 
	          id: i, 
	      ...
	      */
	      ...
	      ranges.push(
	        React.createElement(LsdSliderRange, {
	          key: i, 
	          orientation: this.state.orientation, 
	          length: diff, 
	    ...
	    return (
	      React.createElement("div", {
	        ...
	        style: style, 
	        ref: function(ref)  {return this.componentInstance = ref;}.bind(this)}, " ", /*Refs! Must be a pro.*/
	        ranges, 
	        handles
	      )
	    );
